---
description: >-
  Atlas API 订单维护，用于订单重建、停止出票和预订后的运营订单查询。
---
...
* [重建订单](../../api-reference/post-booking-apis/regenerate-order.md)
...
* [混合支付指南](../booking/booking-step-guides/payment-and-ticketing/hybrid-payment-guide.md)
