---
description: >-
  Atlas API 退款流程，涵盖退款报价、退款提交和退款状态跟踪。
---
...
当订单仍有资格使用专门的作废流程时，使用[作废](void.md)。
...
* [预订后操作](../../support-and-reference/troubleshooting-and-support/faqs/atlas-api-post-ticketing.md)
