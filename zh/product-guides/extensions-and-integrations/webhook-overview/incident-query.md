---
description: >-
  Atlas API 事件查询，用于 webhook 核对、事件过滤以及日程变更或取消跟进。
---
...
将查询结果与[查询订单](../../booking/booking-step-guides/query-order/)和[事件通知](incident-notification.md)结合使用，以确认最终运营状态。
...
* [查询订单](../../booking/booking-step-guides/query-order/)
