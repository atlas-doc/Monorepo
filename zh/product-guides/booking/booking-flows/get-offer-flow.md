...
调用[获取报价](../booking-step-guides/get-offer.md)。
...
使用 `OfferId` 调用[创建订单](../booking-step-guides/create-order.md)。
...
当您在标准搜索路径和获取报价之间做选择时，使用[搜索 vs 报价](../booking-overview/booking-decisions/search-vs-offer.md)。
