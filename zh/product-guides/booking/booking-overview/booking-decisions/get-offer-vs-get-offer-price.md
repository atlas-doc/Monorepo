---
description: 在标准获取报价路径和履约 API 之间做选择。
---
...
当主要问题是业务契合度、共存、定价模式或支付回退时，请使用[履约 API 常见问题](../../../../support-and-reference/troubleshooting-and-support/faqs/fulfilment-api-faq.md)。
...
* [核价出票](../../booking-step-guides/get-offer-price.md)
