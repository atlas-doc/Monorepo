---
description: >-
  `getOfferPrice.do` 在履约 API 路径中的步骤指南，包括更广泛的报价范围、5 分钟出票影响以及转交订单创建。
---
...
当您需要完整的端到端预订序列时，从[履约 API](../booking-flows/fulfillment-flow.md) 开始。

此页面仅涵盖履约 API 的入口步骤。

它不替代完整的履约 API 路径。

当主要问题是产品契合度、与现有接口的共存、定价模式或航司覆盖范围时，请使用[履约 API 常见问题](../../../support-and-reference/troubleshooting-and-support/faqs/fulfilment-api-faq.md)。
...
* [履约 API](../booking-flows/fulfillment-flow.md)
* [履约 API 常见问题](../../../support-and-reference/troubleshooting-and-support/faqs/fulfilment-api-faq.md)
...
* [核价出票](../../../api-reference/booking-apis/get-offer-price.md)
