---
description: >-
  在首次集成通话中使用此检查清单，以对齐流程选择、支付、出票、预订后和发布准备。
---
...
请使用[合作伙伴常见问题](top-questions-for-partners.md)。
{% endhint %}
...
请参阅[座位与行李](../../../product-guides/booking/optional-ancillaries/seats-and-baggage/)。
...
* [预订后](atlas-api-post-ticketing.md)
...
* [生产上线](../../../readme-1/production-go-live.md)
