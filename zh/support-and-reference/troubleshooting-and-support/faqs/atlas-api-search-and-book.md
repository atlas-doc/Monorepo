---
description: >-
  常见的 Atlas API 预订流程问题，涉及 search.do、getOffers.do、验证定价、标识符、乘客数量、时机和报价刷新。
---
...
请参阅[行李](/broken/spaces/6LsKtmbJhZxgxraY5mHB/pages/Ftzqh42LAaE6QYzklv67)。
...
请参阅[座位](/broken/spaces/6LsKtmbJhZxgxraY5mHB/pages/3ujCySdZ8OYYLfGI3iF3)了解当前支持范围。
...
使用 [API 请求限制](/broken/spaces/6LsKtmbJhZxgxraY5mHB/pages/EsovwRrOMFnJMFfWhnMV)获取完整的限制模型。
