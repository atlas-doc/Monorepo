---
description: 常见的 Atlas API 预订流程问题，涉及 search.do、getOffers.do、验证定价、标识符、乘客数量、时机和报价刷新。
---
...
请参阅[座位](../../../product-guides/booking/optional-ancillaries/seats-and-baggage/)了解当前支持范围。
...
使用 [API 请求限制](../../../product-guides/booking/booking-overview/api-request-limits.md)获取完整的限制模型。
