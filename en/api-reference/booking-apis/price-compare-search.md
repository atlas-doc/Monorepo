---
description: >-
  Atlas API priceCompareSearch.do reference for pre-sale route coverage and raw
...
See [Booking Overview](/broken/spaces/6LsKtmbJhZxgxraY5mHB/pages/82DaHlpWfsy0ANSplNI3) for the normal search-to-ticket flow.
